...
{lib}: {
  toHyprConf = attrs: let
    ...
    toHyprConf' = indent: attrs: let
      sections = lib.filterAttrs (n: v: lib.isAttrs v || (lib.isList v && lib.all lib.isAttrs v)) attrs;
      ...
      allFields = lib.filterAttrs (n: v: !(lib.isAttrs v || (lib.isList v && lib.all lib.isAttrs v))) attrs;
