{config, ...}: {
  programs.noctalia.colors = {
    mError = config.theme.colorsWithHashtag.base08;
    mOnError = config.theme.colorsWithHashtag.base0C;
    mOnPrimary = config.theme.colorsWithHashtag.base01;
    mOnSecondary = config.theme.colorsWithHashtag.base01;
